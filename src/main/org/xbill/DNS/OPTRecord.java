...
public class OPTRecord extends Record {
  ...
  /**
   * Creates an OPT Record. This is normally called by SimpleResolver2, but can also be called by a
   * server.
   *
  ...
  /**
   * Creates an OPT Record with no data. This is normally called by SimpleResolver2, but can also be
   * called by a server.
   *
   * @param payloadSize The size of a packet that can be reassembled on the sending host.
   * @param xrcode The value of the extended rcode field. This is the upper 16 bits of the full
