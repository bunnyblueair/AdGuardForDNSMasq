...
/**
 * An implementation of Resolver that sends one query to one server. SimpleResolver2 handles TCP
...
public class SimpleResolver implements Resolver {
  ...
  /**
   * Creates a SimpleResolver2. The host to query is either found by using ResolverConfig, or the
  ...
  /**
   * Creates a SimpleResolver2 that will query the specified host
   *
   * @exception UnknownHostException Failure occurred while finding the host
   */
  ...
  /**
   * Gets the destination address associated with this SimpleResolver2. Messages sent using this
   * SimpleResolver2 will be sent to this address.
   *
   * @return The destination address associated with this SimpleResolver2.
   */
  ...
  public String toString() {
    return "SimpleResolver2 [" + address + "]";
  }
}
